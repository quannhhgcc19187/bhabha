		...
		<!-- <div class="container"> -->
			...
			<div class="DanhSachSanPham">
				<div class="SanPham">
					...
					<div class="row">
						<?php 
						$SanPham = pg_query($Connect,"SELECT a.*,(SELECT b.HSP_TenTapTin FROM hinhsanpham b WHERE a.SP_Ma = b.SP_Ma ORDER BY HSP_TenTapTin LIMIT 1 OFFSET 0) AS AvatarSP, LSP_Ten, c.LSP_Ma FROM sanpham a JOIN loaisanpham c ON a.LSP_Ma = c.LSP_Ma WHERE c.LSP_Ma = 2");
